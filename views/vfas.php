...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="d-flex align-items-center py-3 mb-0.5">
        <h1 class="me-3" >Fases de proyecto</h1>
  ...
  <div class="row">
    <div class="form-group col-md-4">
      <label for="nomubi">Nombre de la fase</label>
    ...
    <div class="form-group col-md-4">
      <label for="nomubi">Fecha de inicio</label>
      <input type="date" name="inifas" id="inifas" class="form-control form-control" required>
    </div>
    <div class="form-group col-md-4">
      <label for="nomubi">Fecha de finalización</label>
      <input type="date" name="finfas" id="finfas" class="form-control form-control" required>
    </div>
