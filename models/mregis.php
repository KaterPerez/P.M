...
function setCodval($codval){
 ...
 //GET Y SET TABLA IE
    ...
    function setPasie($pasie){
        $this->pasie=$pasie;
    }
    function setNomie($nomie){
        $this->nomie=$nomie;
    }
    function setDirie($dirie){
        $this->dirie=$dirie;
    }
    function setTelie($telie){
        $this->telie=$telie;
    }
    ...
    function setTipie($tipie){
        $this->tipie=$tipie;
    }
    function getAll(){
        $res = NULL;
        $sql = "SELECT u.idusu,u.numdoc,u.tipdoc,u.nomusu,u.apeusu,u.corusu,u.telusu,u.pasusu,u.dirusu,
        u.edausu,u.genusu,u.codper,u.codval FROM usuario AS u ";
        // $sql = "SELECT i.nuicie,i.pasie,i.nomie,i.dirie,i.telie,i.corie,i.codubi,i.tipie,
        // u.idusu,u.numdoc,u.tipdoc,u.nomusu,u.apeusu,u.corusu,u.telusu,u.pasusu,u.dirusu,
        // u.edausu,u.genusu,u.codper,u.codval FROM usuario AS u INNER JOIN ie AS i ON u.idusu = i.idusu";
        $modelo = new conexion();
    ...
    function getOne(){
        $res = NULL;
        $sql = "SELECT  nomusu, apeusu, numdoc, tipdoc, telusu, pasusu, dirusu, 
    ...
    function save(){
         ...
         try {
            $res=NULL;
            $sql = "INSERT INTO usuario (numdoc,tipdoc,nomusu,apeusu,corusu,telusu,pasusu,dirusu,
            edausu,genusu,codper) VALUES (:numdoc,:tipdoc,:nomusu,:apeusu,:corusu,:telusu,:pasusu,:dirusu,
